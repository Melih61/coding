...
window = Tk()
titleLabel = Label(window,text='Enter your info',font=('Courier',25)).grid(row=0,column=0,columnspan=2)
...
emailLabel = Label(window,text='E-Mail: ', bg='blue').grid(row=3,column=0)
